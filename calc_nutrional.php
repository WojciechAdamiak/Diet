<html lang="en">
  ...
  class Product {
    ...
    function __construct($name, $kcal, $protein, $fat, $carbohydrates, $dietaryFiber, $sodium, $potassium, $calcium, $phosphor, $magnesium, $vitaminA, $vitaminD, $vitaminE, $vitaminB1, $vitaminB2, $vitaminB3, $vitaminC)
      ...
      public function get_table() {
        ...
        $sql = "INSERT INTO `menu` (`id`, `name`, `quantity`, `kcal`, `protein`, `fat`, `carbohydrates`, `dietaryfiber`, `sodium`, `potassium`, `calcium`, `phosphor`, `magnesium`, `vitaminA`, `vitaminD`, `vitaminE`, `vitaminB1`, `vitaminB2`, `vitaminB3`, `vitaminC` ) VALUES (NULL, '$products', '$quantity', '$kcalM', '$proteinM', '$fatM', '$carbohydratesM', '$dietaryFiberM', '$sodiumM', '$potassiumM', '$calciumM', '$phosphorM', '$magnesiumM', '$vitaminAM', '$vitaminDM', '$vitaminEM', '$vitaminB1M', '$vitaminB2M', '$vitaminB3M', '$vitaminCM')";
  ...
  <a href="calculator_nutrional_value.php" class="promo__button">Menu</a>
